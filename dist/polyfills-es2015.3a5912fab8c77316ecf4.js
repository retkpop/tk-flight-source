    ...
    pDpN: function(e, t) {
      ...
      function se(e, t, n) {
        return (
          ...
          n.configurable ||
            (e[ne] || Object.isFrozen(e) || Q(e, ne, { writable: !0, value: {} }), e[ne] && (e[ne][t] = !0)),
          n
        );
      }
      function ie(e, t, n, o) {
            ...
            (n.args[0] = function() {
              try {
                ...
                (t.data && t.data.isPeriodic) ||
                  ('number' == typeof n.handleId ? delete i[n.handleId] : n.handleId && (n.handleId[be] = null));
              }
            }),
                ...
                'number' == typeof r ? (s = i[r]) : (s = r && r[be]) || (s = r),
                  s && 'string' == typeof s.type
                    ? 'notScheduled' !== s.state &&
                      ...
                      ('number' == typeof r ? delete i[r] : r && (r[be] = null), s.zone.cancelTask(s))
                    : t.apply(e, o);
              }
          ));
      }
      ...
      Zone.__load_patch('legacy', e => {
        ...
        Zone.__load_patch('timers', e => {
          ve(e, 'set', 'clear', 'Timeout'), ve(e, 'set', 'clear', 'Interval'), ve(e, 'set', 'clear', 'Immediate');
        }),
        ...
        Zone.__load_patch('on_property', (e, t, n) => {
          ke(n, e),
            (Object.defineProperty = function(e, t, n) {
              if (re(e, t)) throw new TypeError("Cannot assign to read only property '" + t + "' of " + e);
              const o = n.configurable;
